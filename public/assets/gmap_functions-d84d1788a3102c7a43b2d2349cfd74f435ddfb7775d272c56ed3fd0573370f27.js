  ...
  handler.buildMap({
    ...
    function(){
      ...
      if(!!draggableMarker) {
        ...
        google.maps.event.addListener(Gmaps.marker.serviceObject, 'click', function(event) {
            draggableMarker.lat = event.lat;
            draggableMarker.lng = event.lng;
            console.log("HEY");
            getLatLong();
        });
        console.log(Gmaps.marker.serviceObject);
      }
